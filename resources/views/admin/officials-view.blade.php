            ...
            <div class="col col-lg-3 col-sm-6 col-12">
                <div class="card mt-3 indi-officials" data-position="{{$official->position}}" data-id="{{ $official->id }}">
                    ...
                    <div class="card-body text-center">
                        <img src="{{ $official->welcome_image ? 'https://bagulin.s3-ap-southeast-1.amazonaws.com/officials/'.$official->position.'/'.$official->welcome_image : asset('img/official.png') }}"
