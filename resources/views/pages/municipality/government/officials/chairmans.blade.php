        ...
        @else
            @foreach ($official as $chairman)
                <div class="col-lg-3 mx-auto mt-5 mt-lg-0">
                    <img class="rounded-circle mx-auto d-block" src="{{ $chairman->welcome_image ? '/storage/officials/'.$chairman->position.'/'.$chairman->welcome_image : asset('img/official.png')}}" width="200"/>
