        ...
        @if ($official)
            @foreach ($official as $chairman)
                <div class="col-lg-3 mx-auto mt-5 mt-lg-0">
                    <img class="rounded-circle mx-auto d-block" src="{{ $chairman->about_image ? asset('storage/officials/'.$chairman->position.'/'.$chairman->about_image) : asset('img/official.png')}}" width="200"/>
