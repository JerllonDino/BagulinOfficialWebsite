        ...
        @else
            @foreach ($official as $skchairman)
                <div class="col-lg-3 mx-auto mt-5 mt-lg-0">
                    <img class="rounded-circle mx-auto d-block" src="{{ $skchairman->about_image ? 'https://bagulin.s3-ap-southeast-1.amazonaws.com/officials/'.$skchairman->position.'/'.$skchairman->about_image : asset('img/official.png')}}" width="200"/>
