...
class MunicipalProfileController extends Controller
{
    ...
    public function delete(Request $request) {
        ...
        if ( Storage::disk('s3')->delete( 'municipal-profile/' . $document->category_id . '/' . $document->file_name) ) {
            $document->delete();
        }
    }
    ...
    public function deleteCategory(Request $request) {
        ...
        Storage::disk('s3')->deleteDirectory("municipal-profile/$request->category_id/");
        $category->delete();
    }
