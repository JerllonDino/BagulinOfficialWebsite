...
class OfficialController extends Controller
{
    ...
    public function saveOfficial(Request $request, $count = null) {
        ...
        if ($welcomeBase) {
            ...
            Storage::disk('ftp')->put( 'officials/' . $request->position . '/' . $welcomeImageName, $decodedWelcome['contents']);
        ...
        if($aboutBase){
            ...
            Storage::disk('ftp')->put( 'officials/' . $request->position . '/' . $aboutImageName, $decodedAbout['contents']);
        }
    ...
    public function deleteOfficial($id)
    {
        ...
        if ($official->about_image) {
            Storage::disk('ftp')->delete('officials/'.$official->position.'/'.$official->about_image);
        }
        if ($official->welcome_image) {
            Storage::disk('ftp')->delete('officials/'.$official->position.'/'.$official->welcome_image);
        }
